...
namespace BaiTap_GUI_3
{
    public partial class FormMain : Form
    {
        ...
        private static Bitmap DrawControlToPNG(Control control)
        {
        ...
        {
            Bitmap bitmap = DrawControlToPNG(this.flowLayoutPanelDraw);
            bitmap.Save("draw.png");
            System.Diagnostics.Process.Start("draw.png");
        }
